...
function buyAbook(){
	...
	if(document.getElementById("story").checked){
		...
		alert("you cannot buy story books ");
...
<form action="mybook">
		...
		<font size=4px color=green>Buy Book:</font> <br />
		<br/>
		<table>
			<tr>
				<td>Book Name :</td>
			...
			<tr>
				<td>Buy/Rent :</td>
				<td> <input type="radio" name="BuyRent" id="Rent" value=rent checked/>&nbsp;Rent</td>
				<td><input type="radio" name="BuyRent" id="Buy" value=buy onclick="buyAbook()" />&nbsp;Buy </td>
			</tr>
		...
		<br/>
		&nbsp;&nbsp;<input type="submit" name="submit" value="Buy/Rent" style="background:whitesmoke;"  onclick="return validate()" />
